...
use tokio::{fs::OpenOptions, io::AsyncRead, io::AsyncWriteExt, net::UnixStream};
...
pub trait BlockDevice {
    /// Read a block at offset from device.
...
impl RequestStream {
    fn read_next(&mut self, cx: &mut Context) -> Poll<Option<Result<usize, io::Error>>> {
